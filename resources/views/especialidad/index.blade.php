...
<body>
    ...
    <h1>ESTE ES TU PANEL PARA ESPECIALIDADES</h1>
    <div class="row">
        <div class="col-12">
            <div>
                <h2 class="text-white">PANEL DE ESPECIALIDAD</h2>
            </div>
            <div>
                <a href="{{route('especialidad.create')}}" class="btn btn-primary">CREAR</a>
            </div>
        </div>
        ...
        <div class="col-12 mt-4">
            <table class="table table-bordered text-white">
                ...
                <tr>
                    <td class="fw-bold">{{$especialidad->nombre}}</td>

                    <td>
                    <form action="{{route('especialidad.destroy', ['id'=>$especialidad->id])}}"
                        method="post"
